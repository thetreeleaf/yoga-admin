  ...
  <div class="app-container">
    <el-row :gutter="40">
      <el-col :span="24" :xs="24">
        ...
        <el-table
          ...
          <el-table-column align="center" label="场馆" prop="placeName" width="150"/>
    ...
    <el-dialog :title="dialog.title" :visible.sync="dialog.visible" width="800px">
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="所属场馆" prop="placeId" v-if="this.$store.state.user.placeId == 1">
          <el-select v-model="form.placeId" placeholder="请选择场馆" style="width: 100%" filterable>
            <el-option
  ...
  methods: {
    ...
    async handleAdd() {
      ...
      if(this.$store.state.user.placeId != 1) {
        this.form.placeId = this.$store.state.user.placeId
      }
      await this.loadRoleOptions()
      await this.loadPlaceOptions()
    },
